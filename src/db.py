...
DB_CONFIG = {
    ...
    "auth_plugin": os.getenv("DB_AUTH_PLUGIN"),  # optional per MySQL setup
}
...
def init_db() -> None:
    """Create customers table and indexes if not exist."""
    ddl = """
        ...
        with conn.cursor() as cur:
            ...
            for statement in indexes:
                try:
                    ...
                    if getattr(exc, "errno", None) != 1061:  # ignore duplicate index
                        raise
        conn.commit()
